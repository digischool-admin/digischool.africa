...
Ces 2 labs pratiques vous permettent d'appliquer concrètement les concepts du Module 4 dans un contexte africain réaliste.
...
- Nommage : `data-reporting-decideurs-module-4-labs-[VotreNom].pdf`
- Taille max : 5 MB
...
1. Vous recevez un certificat de complétion du Module 4
2. Le Module 5 est automatiquement débloqué
