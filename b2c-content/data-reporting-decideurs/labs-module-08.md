...
Ces 2 labs pratiques vous permettent d'appliquer concrètement les concepts du Module 8 dans un contexte africain réaliste.
...
### Contexte
Vous êtes consultant(e) pour **AfriTech Solutions**, une entreprise de services basée à Abidjan avec 50 collaborateurs. L'entreprise souhaite optimiser data & reporting pour décideurs pour améliorer ses performances.
...
### Contexte
Vous travaillez pour **MaliDistrib**, entreprise de distribution alimentaire au Mali avec 150 collaborateurs. L'entreprise veut intégrer l'IA dans data & reporting pour décideurs pour gagner en compétitivité.
...
- Nommage : `data-reporting-decideurs-module-8-labs-[VotreNom].pdf`
- Taille max : 5 MB
...
1. Vous recevez un certificat de complétion du Module 8
2. Le Module 9 est automatiquement débloqué
