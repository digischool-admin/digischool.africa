...
Ces 2 labs pratiques vous permettent d'appliquer concrètement les concepts du Module 1 dans un contexte africain réaliste.
...
- Nommage : `data-reporting-decideurs-module-1-labs-[VotreNom].pdf`
- Taille max : 5 MB
...
1. Vous recevez un certificat de complétion du Module 1
2. Le Module 2 est automatiquement débloqué
