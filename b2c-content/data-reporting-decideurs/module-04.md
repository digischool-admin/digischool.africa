---
title: "Module 4 : Data & Reporting pour décideurs - Augmentation par l'IA"
course: "Data & Reporting pour décideurs"
course_slug: "data-reporting-decideurs"
module_number: 4
duration: "90-120 min"
difficulty: "Intermédiaire"
---

# Module 4 : Data & Reporting pour décideurs - Augmentation par l'IA
...
**Contexte :** Cas réel d'une entreprise africaine appliquant data & reporting pour décideurs.
...
### 5 Prompts essentiels pour Data & Reporting pour décideurs

**Prompt 1 : Diagnostic initial**
```
Analyse ma situation actuelle en data & reporting pour décideurs :
...
```
J'ai un problème en data & reporting pour décideurs :
...
```
Aide-moi à créer un dashboard de suivi pour data & reporting pour décideurs :
