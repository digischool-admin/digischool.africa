...
Ces 2 labs pratiques vous permettent d'appliquer concrètement les concepts du Module 7 dans un contexte africain réaliste.
...
- Nommage : `data-reporting-decideurs-module-7-labs-[VotreNom].pdf`
- Taille max : 5 MB
...
1. Vous recevez un certificat de complétion du Module 7
2. Le Module 8 est automatiquement débloqué
