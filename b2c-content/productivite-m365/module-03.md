---
title: "Module 3 : Productivité & Outils (Microsoft 365) - Outils & Méthodologies"
...
# Module 3 : Productivité & Outils (Microsoft 365) - Outils & Méthodologies

## 🎯 Objectifs d'apprentissage

À l'issue de ce module, vous serez capable de :

1. **Comprendre** - Frameworks, méthodologies éprouvées, outils traditionnels
...
### 1. Frameworks reconnus

## Frameworks reconnus

[Contenu pédagogique à développer pour Frameworks reconnus]
...
[Contenu pédagogique à développer pour Outils pratiques]
...
[Contenu pédagogique à développer pour Méthodologie pas-à-pas]
...
### 4. Templates et check-lists

## Templates et check-lists

[Contenu pédagogique à développer pour Templates et check-lists]
...
Voir le fichier `labs-module-03.md` pour les 2 labs détaillés avec contexte africain, inputs, outputs attendus et grille d'évaluation.
...
1. **Frameworks reconnus** - [Message clé 1]
2. **Outils pratiques** - [Message clé 2]
3. **Méthodologie pas-à-pas** - [Message clé 3]
4. **Templates et check-lists** - [Message clé 4]
...
3. Passer au Module 4 (débloqué après validation)
