---
title: "Module 4 : Productivité & Outils (Microsoft 365) - Augmentation par l'IA"
...
# Module 4 : Productivité & Outils (Microsoft 365) - Augmentation par l'IA

## 🎯 Objectifs d'apprentissage

À l'issue de ce module, vous serez capable de :

1. **Comprendre** - Outils IA, automatisations, prompts, cas d'usage
...
### 1. Outils IA disponibles

## Outils IA disponibles

[Contenu pédagogique à développer pour Outils IA disponibles]
...
### 2. Cas d'usage terrain

## Cas d'usage terrain

[Contenu pédagogique à développer pour Cas d'usage terrain]
...
### 3. Pack de 5 prompts essentiels

## Pack de 5 prompts essentiels

[Contenu pédagogique à développer pour Pack de 5 prompts essentiels]
...
[Contenu pédagogique à développer pour Do & Don't avec IA]
...
Voir le fichier `labs-module-04.md` pour les 2 labs détaillés avec contexte africain, inputs, outputs attendus et grille d'évaluation.
...
1. **Outils IA disponibles** - [Message clé 1]
2. **Cas d'usage terrain** - [Message clé 2]
3. **Pack de 5 prompts essentiels** - [Message clé 3]
4. **Do & Don't avec IA** - [Message clé 4]
...
3. Passer au Module 5 (débloqué après validation)
