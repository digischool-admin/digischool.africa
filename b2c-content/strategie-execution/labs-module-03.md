...
### Contexte
Vous êtes consultant(e) pour **AfriTech Solutions**, une entreprise de services basée à Abidjan avec 50 collaborateurs. L'entreprise souhaite optimiser stratégie & exécution pour améliorer ses performances.
...
### Contexte
Vous travaillez pour **MaliDistrib**, entreprise de distribution alimentaire au Mali avec 150 collaborateurs. L'entreprise veut intégrer l'IA dans stratégie & exécution pour gagner en compétitivité.
...
- Nommage : `strategie-execution-module-3-labs-[VotreNom].pdf`
- Taille max : 5 MB
